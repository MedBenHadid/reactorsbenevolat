...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('DonsBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('DonsBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('DonsBundle\Form\ImageType', $image);
